...
public class CrearParlamentoController {
	...
	/**
	 * @author Jose
	 * @param Metodo que verifica si el programa tiene o no parlamentos creados, si ya posee, pasa a la funcion crear usuarios, si no, obliga al usuario a ingresar Parlamenos
	 */
